...
const DEFAULT_EXTRACT_SYSTEM_PROMPT = [
    ...
    '[6] Link plan: exact relation edges to add (from -> relation -> target), or explicit no-link reason.',
    '[7] Planned tool calls: full call list in execution order (done last).',
    '</thought>',
