...
const defaultNodeTypeSchema = [
    ...
    },
    {
        ...
        tableColumns: ['name', 'aliases', 'identity', 'state', 'goal', 'relationship', 'inventory', 'language_sample', 'core_note', 'addressing_user'],
        columnHints: {
    ...
    },
    {
        ...
        tableColumns: ['name', 'aliases', 'controller', 'danger', 'resources', 'state', 'last_event'],
        columnHints: {
